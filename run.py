...
def follow_signs():
    ...
    time.sleep(2)
    print('As you get closer the guard shouts “quick there’s a hoard on the way, get inside.”')
    time.sleep(2)
    print('Panic takes over and you sprint towards the gate as it begins to open.')
    time.sleep(2)
    print("You make it inside the gate and the relief begins to hit… then everything goes black.")
    time.sleep(4)
    print("\nYou begin to come round as they walk you into what looks like a slaughter room.")
    time.sleep(2)
    print("You see a body on a table being dismembered and are placed on your knees ")
    time.sleep(2)
    print("in front of what looks like a large public sink with your hands tied behind your back.")
    time.sleep(2)
    print("Jess in placed to your left along with three others.")
    time.sleep(2)
    print("You edge your knife from your sock and begin to work on your constraints.")
    time.sleep(2)
    print("\nA man with a bat and another with a butcher knife begin to walk")
    time.sleep(2)
    print("towards the person furthest away from you at the other end of the sink.")
    time.sleep(2)
    print("Without warning the man with the bat strikes him in the back of the head")
    time.sleep(2)
    print("and the second slit his throat draining his blood into the sink.")
    time.sleep(2)
    print("They move onto the next and repeat the process getting closer to Jess.")
    time.sleep(2)
    print("You force yourself not to panic and continue to try and cut yourself loose.")
    time.sleep(2)
    print("As the bat is about to make impact for the third time There is a loud bang.")
    time.sleep(2)
    print("The room begins to shake knocking everyone to the ground")
    time.sleep(2)
