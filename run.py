...
def leave():
    ...
    time.sleep(2)
    print("outside before making your move. Do you take the car which could attract nearby zombies")
    time.sleep(2)
...
def kick():
    print("The door crashes open with the impact of your kick knocking") 
    time.sleep(2)
...
def help_driver():
    ...
    time.sleep(2)
    print("You need to get him out of the car do you reach across and open the door, or get out and walk around. (reach or around)")
    time.sleep(2)
