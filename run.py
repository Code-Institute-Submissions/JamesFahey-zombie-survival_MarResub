...
def intro():
    ...
    time.sleep(a)
    print("me and Alex wanted to do something nice with Harry before he")
    time.sleep(a)
    print("started nursery. Glad Alex likes to be prepared, if it ")
    time.sleep(a)
...
def car():
    ...
    time.sleep(a)
    print("Alex straps Harry into his car seat.")
    time.sleep(a)
    ...
    time.sleep(a)
    print("Alex begins to panic and shouts “hurry up, come on we have to go”.")
    time.sleep(a)
    print("“Im trying” you snap back. This causes Harry to cry.")
    time.sleep(a)
...
def crowbar():
    ...
    time.sleep(a)
    print("Alex and Harry are screaming,")
    time.sleep(a)
    ...
    time.sleep(a)
    print("neck. Alex wails in horror just as the growing group of zombies ")
    time.sleep(a)
...
def keep_going():
    ...
    time.sleep(a)
    print("As Alex and Harry sleep the crowd moves in…")
    time.sleep(a)
...
def get_out():
    ...
    time.sleep(a)
    print("You look back at your car and Harry in the back,")
    time.sleep(a)
...
def help_driver():
    ...
    time.sleep(a)
    print("You put him in the front seat and Alex goes to sit with Harry.")
    time.sleep(a)
    ...
    time.sleep(a)
    print("happened to Alex or Harry.")
    time.sleep(a)
    ...
    time.sleep(a)
    print("You begin look him over trying to not alert Alex to issue.")
    time.sleep(a)
...
def reach_across():
    ...
    time.sleep(a)
    print("Alex grabs the crowbar from bellow your seat")
    time.sleep(a)
    ...
    time.sleep(a)
    print("Alex gets Harry out of the car and you stand opposite them.")
    time.sleep(a)
    print("You give them a long hug and a kiss and say your goodbyes.")
    time.sleep(a)
    print('"Are you not coming too dad" Harry asks confused')
    time.sleep(a)
...
def back():
    ...
    time.sleep(a)
    print('"Theres another one of those signs" Alex acknowledges')
    time.sleep(a)
...
def camp():
    ...
    time.sleep(a)
    print('"Do you think we can get it going" Alex asks')
    time.sleep(a)
...
def kick_zombie():
    ...
    time.sleep(a)
    print("\nYou race back to get Alex and Harry,")
    time.sleep(a)
    ...
    time.sleep(a)
    print("and share a smile with Alex.")
    time.sleep(a)
...
def follow_signs():
    ...
    time.sleep(a)
    print("Alex in placed to your left along with three others.")
    time.sleep(a)
    ...
    time.sleep(a)
    print("repeating the process getting closer to Alex.")
    time.sleep(a)
    ...
    time.sleep(a)
    print("Do you attack the guards or free Alex (attack or free")
    time.sleep(a)
...
def free_alex():
    print("You rush to Alex and begin cutting at her constraints.")
    time.sleep(a)
...
def stay():
    ...
    time.sleep(a)
    print("all rations used and Harry cant stop crying due to hunger. ")
    time.sleep(a)
    print("Alex having not eaten in 3 days can barely keep awake.")
    time.sleep(a)
